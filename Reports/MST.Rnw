...
\begin{document}
\title{Pathway fingerprinting tissue MST - hpc111 version}
...
fingerprint.dist<-as.matrix(dist(t(barcode.fingerprint), method = "euclidean"))
...
barcode.dist<-as.matrix(dist(t(barcode.matrix), method = "euclidean"))
