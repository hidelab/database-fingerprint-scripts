...
# save trees
write.tree(GSE24759.parsimony.top,
           file = paste("GSE24759.parsimony.top.", threshold, ".tree", sep = ""))
write.tree(GSE24759.parsimony.consensus,
           file = paste("GSE24759.parsimony.consensus.", threshold, ".tree", sep = ""))
