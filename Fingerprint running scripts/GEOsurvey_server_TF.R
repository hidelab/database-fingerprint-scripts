# Running fingerprint based on squared rank enrichment scores using the transcription factor genesets developed by Oliver Hofmann
...
setwd("/home/galtschu2/database-fingerprint-scripts/TFgenesets")
load("TFmodules.genesets.RData")
lapply(genesets[1:6], load, envir = .GlobalEnv)
setwd("/home/galtschu2/Documents/Projects/Fingerprinting")
...
source("/home/galtschu2/database-fingerprint-scripts/Fingerprint running scripts/Reading in samples_NO_UPDATE.R")
...
path<-"/home/galtschu2/Documents/Projects/Fingerprinting/data/Fingerprints/TF/"
...
a=parallel(source("TF_sq_parallel/TF_parallel_a.R"))
b=parallel(source("TF_sq_parallel/TF_parallel_b.R"))
c=parallel(source("TF_sq_parallel/TF_parallel_c.R"))
d=parallel(source("TF_sq_parallel/TF_parallel_d.R"))
e=parallel(source("TF_sq_parallel/TF_parallel_e.R"))
f=parallel(source("TF_sq_parallel/TF_parallel_f.R"))
g=parallel(source("TF_sq_parallel/TF_parallel_g.R"))
h=parallel(source("TF_sq_parallel/TF_parallel_h.R"))
i=parallel(source("TF_sq_parallel/TF_parallel_i.R"))
j=parallel(source("TF_sq_parallel/TF_parallel_j.R"))
k=parallel(source("TF_sq_parallel/TF_parallel_k.R"))
l=parallel(source("TF_sq_parallel/TF_parallel_l.R"))
m=parallel(source("TF_sq_parallel/TF_parallel_m.R"))
n=parallel(source("TF_sq_parallel/TF_parallel_n.R"))
