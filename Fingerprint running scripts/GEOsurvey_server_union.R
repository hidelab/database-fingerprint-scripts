# Running fingerprint based on median rank enrichment scores using pathprint genesets compiled by Gabriel
...
load("pathwayUnion.genesets.RData")
...
path<-"/home/galtschu2/Documents/Projects/Fingerprinting/data/Fingerprints/Union/"
