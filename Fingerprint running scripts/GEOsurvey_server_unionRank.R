# Creating gene rank matrix using union of GPL1261 and GPL570 chips
...
path<-"/home/galtschu2/Documents/Projects/Fingerprinting/data/Fingerprints/UnionRank/"
...
# these scripts run for returning the gene rank only
a=parallel(source("parallel/rank/parallel_a.R"))
b=parallel(source("parallel/rank/parallel_b.R"))
c=parallel(source("parallel/rank/parallel_c.R"))
d=parallel(source("parallel/rank/parallel_d.R"))
e=parallel(source("parallel/rank/parallel_e.R"))
f=parallel(source("parallel/rank/parallel_f.R"))
g=parallel(source("parallel/rank/parallel_g.R"))
h=parallel(source("parallel/rank/parallel_h.R"))
i=parallel(source("parallel/rank/parallel_i.R"))
j=parallel(source("parallel/rank/parallel_j.R"))
k=parallel(source("parallel/rank/parallel_k.R"))
l=parallel(source("parallel/rank/parallel_l.R"))
m=parallel(source("parallel/rank/parallel_m.R"))
n=parallel(source("parallel/rank/parallel_n.R"))
